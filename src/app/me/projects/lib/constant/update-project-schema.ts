import { z } from 'zod';
import { STACK_REGEX } from '../constant/regex';
import { MAX_FILE_SIZE } from '../constant/max-file-size';

export const UPDATE_PROJECT_CONFIG = {
  name: z
    .string()
...
export const UPDATE_PROJECT_SCHEMA = z.object(UPDATE_PROJECT_CONFIG);
