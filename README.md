...
- Большая часть проекта общается через Apollo GraphQL, другая через Axios

- Стейт менеджер Mobx (В планнах лучше попилить на маленькие стейт менеджеры и перенести филтьтрацию с пагинацией на бек)
...
Этот вариант собирает прямиком с докерхаба, но для него нужно настроить ci/cd, чтобы проект собирался и отправлял артифакты на докерхаб
